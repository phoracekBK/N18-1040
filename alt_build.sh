...
M_LIB="-I$HOME/lib/include -L$HOME/lib/ -lc_freq -laclib -lsettings_button  $(pkg-config --libs --cflags gtk+-3.0) $(libgcrypt-config --libs --cflags) -pthread -lconfig -lcomedi -lm -lc_regulation"
