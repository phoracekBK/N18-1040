...
{    
    ...
    cz_lang->print_state_pause = "Job pozastaven";
    ...
    cz_lang->g_cnt_compenzation_lbl = "Náhrady:";
...
void lang_init_english(lang * en_lang)
{
 /* English labels */
    ...
    en_lang->print_state_pause = "Job paused";
    ...
    en_lang->g_cnt_compenzation_lbl = "Sheet compenzation:";
